# RIP QIWI 2007-2024
Так как КИВИ больше не работают в России, я больше не буду обновлять эту библиотеку. Вроде бы в Казахстане банк всё ещё живой, поэтому, вероятно, эта апишка всё ещё работает для счетов на Тенге, feel free написать мне, если это так.
# qiwi-p2p-api
